...
first = cv2.imread("rosalina/3929,8bs6kf.png")
second = cv2.imread("rosalina/2459,54rgx8.jpg")

first = cv2.resize(first, (16, 16), interpolation=cv2.INTER_AREA)
second = cv2.resize(second, (16, 16), interpolation=cv2.INTER_AREA)
